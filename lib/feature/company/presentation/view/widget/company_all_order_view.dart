...
class CompanyAllOrderView extends StatelessWidget {
  const CompanyAllOrderView({super.key});
            ...
            itemBuilder: (context, index) => InkWell(
              onTap: () {
                PersistentNavBarNavigator.pushNewScreen(context,
                    screen: CompanyOrderDetailsView(orderModel: cubit.allOrders[index],type: 'all',));
              },
